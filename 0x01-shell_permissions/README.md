this readme file has info about all the scripts that are in this directory
...
9-John_Doe: this script mode of the file hello to this -rwxr-x-wx
...
101-symbolic_link_permissions: this script Write a script that changes the owner and the group owner of _hello to vincent and staff respectively.
